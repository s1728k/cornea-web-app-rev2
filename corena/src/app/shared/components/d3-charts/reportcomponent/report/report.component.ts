...
export class ReportComponent implements OnInit {
  ...
  //----------------for Purchase Order-------------------------------------------------------------------
  statusListPo: string[] = ['slno', 'Material Name', 'Usage Count', 'Rate', 'Amount']
  demoPo: {} = {};
  ...
  attrDispPo: string[] = ['slno.', 'Material Name', 'Usage Count', 'Rate', 'Amount']
  attrNamesPo: string[] = ['slno.', 'Material Name', 'Usage Count', 'Rate', 'Amount']
...
// ----------------for Indents----------------------------------------------------------------------
  statusListInd: string[] = ['slno', 'Material Name', 'Usage Count', 'Rate', 'Amount']
  demoInd: {} = {'slno': 2, 'Material Name': 12, 'Usage Count': 20, 'Rate': 20, 'Amount': 0};
