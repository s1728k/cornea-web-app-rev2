...
import {IGanttOptions, Project, Zooming} from "../../../lib/shared/interfaces";

@Component({
  selector: 'app-ganttchart-dialog',
  templateUrl: './ganttchart-dialog.component.html',
  styleUrls: ['./ganttchart-dialog.component.css']
})

export class GanttchartDialogComponent implements OnInit {
  ...
  constructor(@Inject(MD_DIALOG_DATA) public data: any, public dialogRef: MdDialogRef<GanttchartDialogComponent>) {
